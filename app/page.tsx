...
const recentJournal = [
  {
    title: "NVDA breakout retest",
    contract: "150C · Jun 19",
    date: "Today · 9:42 AM",
    note: "Entered on pullback into prior breakout level. IV expanded with underlying reclaiming intraday trend.",
    tag: "Swing",
  },
  {
    title: "TSLA trend continuation",
    contract: "210C · Jul 17",
    date: "Yesterday · 2:18 PM",
    note: "Watched spread tighten and volume accelerate before entry. Took partial into first expansion.",
    tag: "Momentum",
  },
  {
    title: "PLTR failed follow through",
    contract: "38C · May 16",
    date: "Apr 17 · 11:05 AM",
    note: "Underlying lost level and contract repriced quickly on IV fade. Good reminder to size lighter into extension.",
    tag: "Review",
  },
];
...
function MockDashboard() {
  ...
  const contributionRows: [string, string, string, string][] = [
    ...
    ["Theta decay", "-$0.18", "10%", "Headwind"],
    ["Gamma / delta change", "+$0.21", "11%", "Supportive"],
    ["Spread / liquidity drag", "-$0.07", "4%", "Minor"],
    ["Residual", "+$0.22", "12%", "Noise"],
  ];
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="mt-1 text-xl font-semibold text-white">
                    {selected.ticker} {selected.contract}
                  </h3>
                </div>
              ...
              <div className="rounded-[1.75rem] border border-zinc-800 bg-zinc-900 p-5">
                ...
                <div className="mt-4 space-y-3">
                  {[
                    ...
                    ["10:10 AM", "Underlying reclaimed VWAP"],
      ...
      <main>
        ...
        <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8" id="features">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-3">
            <FeatureCard
              eyebrow="History"
              title="Historical contract tracking"
              description="See how a contract moved over time with price history, IV changes, daily volume, relative volume, and open interest in one clean snapshot."
            />
            <FeatureCard
              eyebrow="Attribution"
              title="What moved the contract"
              description="Break down contract performance into underlying move, IV expansion, theta decay, gamma effects, and residual repricing so you can see what actually drove P&L."
            />
            <FeatureCard
              eyebrow="Review"
              title="Journal and replay"
              description="Save your thesis, track entries and exits, and review what happened after the trade with timeline context and a cleaner post-trade workflow."
            />
          </div>
        </section>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              ...
              <div className="flex flex-col gap-3 sm:flex-row lg:min-w-[320px] lg:flex-col">
                <input
                  ...
                  className="h-12 rounded-2xl border border-zinc-800 bg-zinc-950 px-4 text-sm outline-none placeholder:text-zinc-500 focus:border-zinc-600"
                />
                <button className="h-12 rounded-2xl bg-white px-6 text-sm font-medium text-zinc-950 transition hover:opacity-90">
                  Join waitlist
                </button>
